...
- [Ivy] Communication: This section gives the viewer an option to sign up for the company's newsletter to recieve information on cat availibility/wellbeing and location/hours of operation updates. There is an input field to subscribe the user's email to the newsletter on a beautiful orange cat background.
- [Darius] Footer: The footer also includes the same logo as the fixed navbar for consistency and visual-appeal as well as the business' tagline "Local cat adoption, made simple." Below this are numerous options for inforamtion on "Adopt"-ing a cat, "About" the business and how to contact them, and "Help" for any questions user's may have about resources, volunteering, and donating.
